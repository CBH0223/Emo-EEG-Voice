...
# load data
with open('/root/autodl-tmp/mdd/data/EEG/Emo-features/DEX_data.pkl', 'rb') as f:
    DE_x = pickle.load(f)

with open('/root/autodl-tmp/mdd/data/EEG/Emo-features/DEy_data.pkl', 'rb') as f:
    DE_y = pickle.load(f)

# transpose
DE_x = DE_x.transpose(0, 3, 1, 2)
...
train_model(DE_x, DE_y, label_indices, 'DE')
